...
\begin{cventries}
  ...
  \cventry
    {Designer + Developer}
    {\href{https://github.com/bryanluu/GRID-arcade}{GRID Arcade}}
    {Personal Project}
    {August 2025 - Present}
    {
      \begin{cvitems}
        ...
        \item Practiced \textbf{Object-Oriented} programming and \textbf{Memory-efficient Design} to implement 4 different game-modes on limited hardware.
        \item Developed an \textbf{emulation} of software to debug control and game logic before hardware testing.
        \item Collaborated with a mechanical engineer to package system into a polished and robust product.
      \end{cvitems}
    }
    % \cventry
    %     {Designer + Developer}
    %     {\href{https://bryanluu.github.io/a-maze-ing-race-web/}{A-Maze-ing Race (Web Version)}}
    %     {Personal Project}
    %     {March 2025 - July 2025}
    %     {
    %         \begin{cvitems}
    %             \item Implemented a web port of my maze-generating game from C++ to \textbf{TypeScript} and \textbf{JQuery}, enabling new features and greater accessibility.
    %             \item Strengthened knowledge of graph \textbf{algorithms} to generate maze and game logic efficiently each web session.
    %             \item Practiced \textbf{responsive design} for \textbf{UX} of game in mobile and desktop views.
    %         \end{cvitems}
    %     }
  \cventry
